...
ns_section ns/parameters {
    ...
    ns_param    serverlog           ${logroot}/error-rp.log
}
...
ns_section ns/server/default/module/revproxy {
    ns_param filters {
       ...
       # ns_register_filter postauth PUT    /* ::revproxy::upstream -target http://127.0.0.1:18091/
        ns_register_filter postauth GET    /* ::revproxy::upstream -target http://rp_test_naviserver_be:18091/
        ns_register_filter postauth POST   /* ::revproxy::upstream -target http://rp_test_naviserver_be:18091/
        ns_register_filter postauth PUT    /* ::revproxy::upstream -target http://rp_test_naviserver_be:18091/
  }
}
